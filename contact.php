...
<body>
 ...
 <!-- main image slider container -->
            ...
            <div class="row contact-form py-lg-5">
                ...
                <div class="col-lg-6  px-lg-5 map contact-right">
                    <div class="address">
                        ...
                        <div class="row py-3 wthree-cicon">
                            ...
                            <a href="mailto:kosipratishthan@gmail.com">kosipratishthan@gmail.com</a>
                        </div>
                        <div class="row py-3  wthree-cicon">
                            <span class="fas fa-phone-volume mr-3"></span>
                            <h6>+91-9871856053,9907330393</h6>
                        </div>
                        <div class="row py-3  wthree-cicon">
                            <span class="fas fa-globe mr-3"></span>
                            <a href="http://kosipratishthan.com/">kosipratishthan.com</a>
                        </div>
                                           </div>
                </div>
                <!-- //contact left grid -->
                ...
                <div class="col-lg-6 wthree-form-left mt-lg-0 mt-3">
                    ...
                    <div class="contact-top1">
                        ...
                        <form method="post" class="f-color pt-3">
                            ...
                            <div class="form-group my-4">
                             ...
                             <div class="form-group my-4">
                                <label for="contactemail">Mobile No.</label>
                            ...
                            <input type="submit" name="save-contact" value="submit">
                        </form>
                    </div>
                </div>
                <!--  //contact right grid -->
    ...
    <!-- map -->
    <div class="map px-2">
        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2830.3603841744202!2d86.99055731441841!3d26.35264238337203!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39efa9485b765a87%3A0x4c1fd89bb2a991dc!2sKosi+Pratishthan!5e1!3m2!1sen!2sin!4v1561707651534!5m2!1sen!2sin"></iframe>
