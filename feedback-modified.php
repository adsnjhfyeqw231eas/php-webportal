...
<body>
 ...
 <!-- main image slider container -->
    ...
    <h1 style="margin-top: 20px; color: #2118b4;font-weight: bolder;">Feedback</h1><br>
...
include 'db/db.php';
echo "This is db.php";
include 'feedback_ins.php';
echo "This is feedback_ins.php";
?>
</body>
</html>
